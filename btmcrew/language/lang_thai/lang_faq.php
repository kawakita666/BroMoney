...
$faq[] = array("มีข้อความ <b>'The supplied client email address could NOT be verified'</b> เมื่อฉันพยายามสมัครสมาชิกหรือเปลี่ยน email", "อาจเกิดจากหลายสาเหตุ. คุณอาจป้อน email ผิด, อาจไม่มี email นั้นอยู่จริง, จดหมายอาจเต็ม, หรืออาจติดต่อ SMTP server ไม่ได้");
$faq[] = array("มีข้อความ <b>'Could not connect to the email server'</b> เมื่อฉันพยายามสมัครสมาชิกหรือเปลี่ยน email", "อาจเกิดจากหลายสาเหตุ. คุณอาจป้อน email ผิด, SMTP server ของคุณอาจขัดข้อง, หรืออาจมีปัญหาเกี่ยวกับ DNS ของ SMTP server ของคุณ");

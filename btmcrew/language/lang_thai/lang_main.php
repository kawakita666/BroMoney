...
$lang['Hidden'] = 'ซ่อน';
$lang['is_online'] = '%s กำลัง online อยู่';
$lang['is_offline'] = '%s กำลัง offline อยู่';
$lang['is_hidden'] = '%s กำลังซ่อนอยู่';
$lang['Online_status'] = 'สถานะ';
// End add - Online/Offline/Hidden Mod

// Start add - Validate email MOD
$lang['Client_not_verifyed']='The supplied client email address could NOT be verified, คลิก %s เพื่ออ่านข้อมูลเพิ่มเติม';//%s are substituded with a link to the FAQ page
$lang['No_connect_server'] ="Could not connect to the email server, คลิก %s เพื่ออ่านข้อมูลเพิ่มเติม";//%s are substituded with a link to the FAQ page
// End add - Validate email MOD

// Start add - Last visit MOD
$lang['Last_logon'] = 'ทำงานล่าสุด'; 
$lang['Hidde_last_logon'] = 'ถูกซ่อน'; 
$lang['Never_last_logon'] = 'ไม่เคย'; 
$lang['Users_today_zero_total'] = 'วันนี้มีผู้ใช้เข้ามาทั้งหมด <b>0</b> คน :: ';
$lang['Users_today_total'] = 'วันนี้มีผู้ใช้เข้ามาทั้งหมด <b>%d</b> คน :: ';
$lang['User_today_total'] = 'วันนี้มีผู้ใช้เข้ามาทั้งหมด <b>%d</b> คน :: ';
$lang['Users_lasthour_explain'] = ', %d คนใน 1 ชั่วโมงที่ผ่านมา'; 
...
$lang['Week'] = 'สัปดาห์';
$lang['Day'] = 'วัน';
$lang['Total_online_time'] = 'รวมระยะเวลา Online'; 
$lang['Last_online_time'] = 'ระยะเวลา Online ล่าสุด'; 
$lang['Number_of_visit'] = 'จำนวนการเข้าชม'; 
$lang['Number_of_pages'] = 'หน้าที่เปิดอ่าน'; 
// End add - Last visit MOD

// Start add - Birthday MOD
$lang['Birthday'] = 'วันเกิด(ปี ค.ศ.)';
$lang['No_birthday_specify'] = '(ไม่ระบุ)';
$lang['Age'] = 'อายุ';
$lang['Wrong_birthday_format'] = 'คุณระบุรูปแบบวันเกิดไม่ถูกต้อง';
$lang['Birthday_to_high'] = 'ขออภัย บอร์ดนี้ไม่อนุญาตผู้ใช้ที่อายุมากกว่า %d ปี';
$lang['Birthday_require'] = 'คุณต้องระบุวันเกิดด้วย';
$lang['Birthday_to_low'] = 'ขออภัย บอร์ดนี้ไม่อนุญาตผู้ใช้ที่อายุน้อยกว่า %d ปี';
...
$lang['Birthday_greeting_today'] = 'สุขสันต์วันเกิดครบรอบอายุ %s ปีครับ.<br /><br /> จากทีมงานบอร์ด'; // %s is substituted with the users age
$lang['Birthday_greeting_prev'] = 'สุขสันต์วันเกิดย้อนหลังครบรอบอายุ %s ปี ในวันที่ %s ครับ.<br /><br /> จากทีมงานบอร์ด'; // %s is substituted with the users age, and birthday
$lang['Greeting_Messaging'] ='ขอแสดงความยินดี';
$lang['Birthday_today'] = 'ผู้ใช้ที่เกิดวันนี้:';
$lang['Birthday_week'] = 'ผู้ใช้ที่เกิดในช่วง %d วัน นับจากวันนี้:';
$lang['Nobirthday_week'] = 'ไม่มีผู้ใช้ที่เกิดในช่วง %d วัน นับจากวันนี้'; // %d is substitude with the number of days
$lang['Nobirthday_today'] = 'ไม่มีผู้ใช้ที่เกิดวันนี้';
$lang['Year'] = 'ปี';
$lang['Month'] = 'เดือน';
$lang['Day'] = 'วัน';
...
// PJIRC MOD
$lang['Chat_Room'] = 'ห้องแชท';
$lang['IRC_commands'] = 'คำสั่ง IRC Chat';
$lang['IRC_commands_explain'] = 'คำสั่งเหล่านี้จะทำงานเมื่อคุณเข้าไปใช้บริการในห้องแชท. แยกแต่ละคำสั่งด้วยเซมิ-โคลอน. <br />ตัวอย่าง:<br /> /msg nickserv identify password;<br />/beep';
$lang['IRC_disabled'] = '<b>ห้องแชทของเรากำลังปิดอยู่.</b> กรุณามาใหม่ภายหลัง.';

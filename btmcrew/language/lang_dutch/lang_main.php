...
// Stefan Koopmanschap, stefan koopmanschap, stefan@stefankoopmanschap.nl, www.stefankoopmanschap.nl
//
...
$lang['Click_return_modcp'] = 'klik %shier%s om terug te keren naar het Moderator Controle Paneel';
...
$lang['No_topic_id'] = 'Je moet aangeven op welk onderwerp je wil reageren.';
...
$lang['bbcode_q_help'] = 'Quote tekst: [quote]tekst[/quote]  (alt+q)';
$lang['bbcode_c_help'] = 'Code weergave: [code]code[/code]  (alt+c)';
...
$lang['You_new_pm'] = 'Er is een nieuwe priv&eacute; bericht voor je in je Inbox';
$lang['You_new_pms'] = 'Er zijn nieuwe priv&eacute; berichten voor je in je Inbox';
...
$lang['Cannot_send_privmsg'] = 'De beheerder heeft ervoor gezorgd dat je geen priv&eacute; berichten meer kan versturen';
...
$lang['Edit_message'] = 'Bewerk een priv&eacute; bericht';
...
$lang['No_themes'] = 'Geen themas in database';
$lang['Timezone'] = 'Tijdszone';
$lang['Date_format'] = 'Datum weergave';
$lang['Date_format_explain'] = 'De syntax die gebruikt wordt is gelijk aan de syntax van de PHP functie <a href=\"http://nl.php.net/manual/nl/function.date.php\" target=\"_other\">date()</a>';
...
$lang['Public_view_email'] = 'Iedereen mag mijn e-mailadres zien';

$lang['Current_password'] = 'Huidige wachtwoord';
$lang['New_password'] = 'Nieuwe wachtwoord';
$lang['Confirm_password'] = 'Bevestig wachtwoord';
$lang['Confirm_password_explain'] = 'Je moet je huidige wachtwoord invoeren indien je je wachtwoord of e-mailadres wilt aanpassen';
...
$lang['Avatar'] = 'Avatar';
$lang['Avatar_explain'] = 'Laat een kleine afbeelding onder je naam zien in ieder bericht. Je kan maar &eacute;&eacute;n afbeelding tegelijkertijd gebruiken, de breedte mag niet meer dan %d pixels zijn, de hoogte moet onder de %d pixels blijven. De maximale bestandsgrootte is %dKB';
...
$lang['Notify_on_privmsg'] = 'Breng me op de hoogte als ik nieuwe Priv&eacute; berichten heb';
$lang['Popup_on_privmsg'] = 'Laat een pop-up zien als ik nieuwe Priv&eacute; berichten heb';
$lang['Popup_on_privmsg_explain'] = 'Sommige templates openen een nieuw schermpje (pop-up) als er nieuwe priv&eacute; berichten zijn';
$lang['Hide_user'] = 'Onzichtbaar in \'Online gebruikers\' lijst';

$lang['Profile_updated'] = 'Je profiel is bijgewerkt';
$lang['Profile_updated_inactive'] = 'Je profiel is bijgewerkt, al heb je wel belangrijke informatie aangepast waardoor je account nu tijdelijk uitgeschakeld is. Controleer je e-mail om te kijken hoe je je account weer kun activeren of, als dit door de beheerder gedaan word, wacht dan tot de beheerder dit gedaan heeft.';
...
$lang['Email_taken'] = 'Sorry, maar dit e-mailadres is al gebruikt door een gebruiker';
$lang['Email_banned'] = 'Sorry, maar dit e-mailadres is gebanned';
...
$lang['Account_inactive'] = 'Je account is aangemaakt maar moet nog geactiveerd worden. Een activerings code is opgestuurd naar het e-mailadres dat je hebt opgegeven. Controleer je e-mail voor meer informatie';
...
$lang['Already_activated'] = 'Je hebt je account al geactiveerd';
$lang['COPPA'] = 'Je account is aangemaakt maar moet goedkeuring krijgen, bekijk je e-mail voor meer details.';
...
$lang['Password_updated'] = 'Een nieuw wachtwoord is aangemaakt, bekijk je e-mail voor meer details over hoe je deze moet activeren';
$lang['No_email_match'] = 'Het e-mailadres komt niet overeen met het adres dat bij ons bekend is voor deze gebruiker';
...
$lang['Send_email_msg'] = 'Verstuurd een e-mail bericht';
...
$lang['CC_email'] = 'Stuur jezelf een kopie van dit e-mailbericht';
$lang['Email_message_desc'] = 'Dit bericht word verstuurd als eenvoudige tekst, gebruik geen HTML of BBCode. Het antwoord adres wordt je eigen e-mailadres.';
...
$lang['Confirm_code_explain'] = 'Voer de code in exact zoals je die ziet. Let op hoofdletters, een nul heeft een diagonale lijn.';
...
$lang['You_been_banned'] = 'Je bent verbannen op dit forum.<br />Neem contact op met de webmaster of forum beheerder voor meer informatie.';
...
$lang['Reg_user_online'] = 'Er is %d geregistreerde en '; // There ae 5 Registered and
...
$lang['Split_Topic'] = 'Controle Paneel voor splitsen van onderwerpen';

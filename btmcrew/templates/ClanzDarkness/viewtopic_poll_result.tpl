			...
			<tr> 
			  ...
			  <td> 
				<table cellspacing="0" cellpadding="0" border="0">
				  <tr> 
					<td><img src="templates/ClanzDarkness/images/vote_lcap.gif" width="4" alt="" height="12" /></td>
					...
					<td><img src="templates/ClanzDarkness/images/vote_rcap.gif" width="4" alt="" height="12" /></td>
				  </tr>
				</table>
			  </td>

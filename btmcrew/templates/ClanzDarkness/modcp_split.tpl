...
<form method="post" action="{S_SPLIT_ACTION}">
  ...
  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
	  ...
	  <td width="100%" valign="top" class="{postrow.ROW_CLASS}"> 
		<table width="100%" cellspacing="0" cellpadding="3" border="0">
		  <tr> 
			<td valign="middle"><img src="templates/ClanzDarkness/images/icon_minipost.gif" alt="{L_POST}"><span class="postdetails">{L_POSTED}: 
	...
	<tr> 
	  <td colspan="3" height="1" class="row3"><img src="templates/ClanzDarkness/images/spacer.gif" width="1" height="1" alt="."></td>
	</tr>
	<!-- END postrow -->
	<tr> 

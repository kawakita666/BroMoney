...
<table width="100%" border="0" cellspacing="2" cellpadding="0">
  <tr> 
    ...
    <table width="449" border="1" cellpadding="0" cellspacing="0" bordercolor="<?php echo "$td_border"; ?>" bgcolor="<?php echo "$td_bg"; ?>">
        <tr> 
          <td height="22" colspan="2" background="black"><center class="TableHeading">
             Bank Transfers </center></td>
        </tr>
        <tr> 
          <td width="257" height="13" valign="top">FROM Send TO</td>
          <td width="186" valign="top">Amount</td>
        </tr>
        <?php

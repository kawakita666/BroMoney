...
<form action="" method=POST>
        ...
        <table width="100%" border="0" cellspacing="3" cellpadding="0">
          <tr>
            <td width="100%">Well Done You Have Finished The Mission's Your now on your own from here try to do as many crimes and GTA's<br>
              Remember Keep Your Friends Close & Your Enemy Closer<br>
              Go For It Gangster. <br> <br></font>
              </td>
          </tr>
        </table>
</form>

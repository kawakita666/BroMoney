...
echo "You have done a crime recently you have to wait for $left seconds!";
exit();
}
...
if ($radiobutton == "0"){
  $win = rand(100,200);
  $success = $chance[0];
  $quote="The child starts crying";
}elseif ($radiobutton == "1"){
  $win = rand(20,40);
  $success = $chance[1];
  $quote="You smash the coffee machine And A Pipe And Bowl Fell Out :D";

}elseif ($radiobutton == "2"){
  $win = rand(500,1000);
  $success = $chance[2];
  $quote="The old lady attempts to hit you, but she falls over doing so";
}elseif ($radiobutton == "3"){
  $win = rand(1000,2000);
  $success = $chance[3];
  $quote="The supermarket owner starts crying and hands over the cash";
}elseif ($radiobutton == "4"){
  $win = rand(2000,4000);
  $success = $chance[4];
  $quote="You compleate the job and your boss pays you well";
...
mysql_query("UPDATE user_info SET crimes=crimes+1 WHERE username='$username'");
  ...
  if ($radiobutton == "0"){
  $quote="You start crying as the child kicks you in the privates";
}elseif ($radiobutton == "1"){
$quote="hot water starts pouring over your leg";
}elseif ($radiobutton == "2"){

  $quote="The old lady hits you and you run away";
}elseif ($radiobutton == "3"){

  $quote="The security gueards pounce on you";
}elseif ($radiobutton == "4"){

  $quote="The job fails and your boss gets angry";
}elseif ($radiobutton == "5"){
...
echo "$quote Bad luck, you got away with sweet FA!";

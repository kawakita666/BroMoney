...
if ($the_get == "Slots" || $the_get == "RPS" || $the_get=="Race" || $the_get == "Roulette"){
...
$shop = mysql_fetch_object(mysql_query("SELECT * FROM shop WHERE location='$locations[$i]'"));
  ...
  ?>
	...
	<table width="100%" border="1" cellpadding="2" cellspacing="0" bordercolor="black" class=thinline>
        ...
        <tr>
         <td height="19" valign="top">Roulette</td>
          <td width="291">
            <?php if ($casino_roulette->owner == "0"){ echo "No owner-<a href='?grab=Casino&location=$locations[$i]&casino=roulette'>Grab it</a>"; }else{ echo "<a href='profile.php?viewuser=$casino_roulette->owner'>$casino_roulette->owner</a>";  } ?>
          </td>
          <td width="324"> <? echo "£".makecomma($casino_roulette->max).""; ?></td>
        </tr>
        <tr>

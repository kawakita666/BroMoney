...
<tr><td align=right>Red:</td><td><input type=text size=8 name=red maxlength="10"></td>
<td align=right>Black:</td><td><input type=text size=8 name=black maxlength="10"></td>
<td align=right>Odd:</td><td><input type=text size=8 name=o maxlength="10"></td>
<td align=right>Even:</td><td><input type=text size=8 name=e maxlength="10"></td></tr>
<tr><td align=right>1-18:</td><td><input type=text size=8 name=teen maxlength="10"></td>

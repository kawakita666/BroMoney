...
<?php if ($inbox_msg != "0"){ echo "<a href=inbox.php target=middle><img border=0 src=images/newmail.jpg align=left  width=122 height=80></a> "; }else{ echo "<img src=images/nomail.jpg align=left width=122 height=80>"; } ?>
</body>
</html>

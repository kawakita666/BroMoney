...
<form name="form1" method="post" action="">
  <table width="53%" height="127" border="1" align="center" cellpadding="2" cellspacing="0" bordercolor=black class=thinline>
    ...
    <tr bgcolor="#000000">
      <td width="67%" height="9" valign="top" bgcolor="#000000" ><input type="radio" name="radiobutton" value="0" onClick="this.document.img.src='images/jack/house.gif'">
        Steal from streets</td>
      <td width="33%" valign="top" bgcolor="#000000"><?php echo "$chance[0]"; ?>&nbsp;%</td>
    </tr>
    <tr bgcolor="#000000">

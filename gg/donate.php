...
<table width="72%" border="1" align="center" cellpadding="2" cellspacing="0" class=thinline bordercolor=black>
  ...
  <tr>
    <td><p>&gt;<strong>What will i get?</strong><br>
        A.Well you will simply get &pound;50,000 in game money and your click
        limit raised to 30 rather than 15.</p>
      <p>&gt;<strong>Hold on! how much dos it cost? and whats the catch?<br>
        </strong>A. It will cost about &pound;2.00 Pounds sterling, and the catch
        is that you an only use it for the current account.</p>
      <p>&gt;<strong>Ok, im ready lets go!<br>
        </strong>A. Well you will need either a credit card, or a mobile phone
        handy. Then choose the company you wish to use (NOTE: Paypal: for credit
        cards, Echecks and other paypal accounts.).</p>
      <p><strong>Select Your desired service:<br>
        </strong></p>
